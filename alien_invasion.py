...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            #Сброс статистики предыдущей игры
    ...
    def _update_bullets(self):
        ...
        self.bullets.update()
        #Удаление снарядов вне края экрана
    ...
    def _check_aliens_bottom(self):
        """Проверяет достигли ли пришельцы до нижнего края экрана."""
        screen_rect = self.screen.get_rect()
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                #GAMEOVER Происходит то же, что и при столкновении с кораблем.
                self._ship_hit()
                break
    ...
    def _update_aliens(self):
        ...
        #Проверить что пишелец добрался до нижнего края экрана.
